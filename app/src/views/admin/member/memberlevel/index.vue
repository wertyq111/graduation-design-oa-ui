    ...
    <el-card shadow="never">
      ...
      <ele-pro-table
        ...
        <template slot="toolbar">
          <el-button
            v-if="permission.includes('sys:memberlevel:add')"
            class="ele-btn-icon"
            icon="el-icon-plus"
            size="small"
            type="primary"
          ...
          <el-button
            v-if="permission.includes('sys:memberlevel:dall')"
            class="ele-btn-icon"
            icon="el-icon-delete"
            size="small"
            type="danger"
        ...
        <template slot="action" slot-scope="{row}">
          <el-link
            v-if="permission.includes('sys:memberlevel:edit')"
            :underline="false"
            icon="el-icon-edit"
            type="primary"
          ...
          <el-popconfirm
            ...
            @confirm="remove(row)">
            <el-link
              v-if="permission.includes('sys:memberlevel:delete')"
              slot="reference"
              :underline="false"
              icon="el-icon-delete"
              type="danger">删除
