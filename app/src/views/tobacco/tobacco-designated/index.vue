    ...
    <el-card shadow="never">
      ...
      <ele-pro-table
        ...
        <template slot="toolbar">
          <el-button
            v-if="permission.includes('sys:tobacco-designated:import')"
            class="ele-btn-icon"
...
export default {
  ...
  methods: {
    ...
    getColumns() {
      ...
      this.$http.get('/tobacco-designated/getColumns', {params: this.where}).then(res => {
        if (res.data.code === 0) {
          // 清空统计值填充
          this.statisticsFill = {}
